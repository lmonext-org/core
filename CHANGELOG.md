...
- Changelog: 1.11.0 - save_ergebnisse verarbeitet jetzt zusätzlich das neue gt_<id>-Feld (Grüne-Tisch-Entscheidung, siehe admin/view_spieltag.php) und speichert es in liga_partien.gt_entscheidung.
