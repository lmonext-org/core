...
if ($action === 'liga_settings' && isLoggedIn()) {
    ...
    if ($lid > 0) {
        try {
            ...
            // Einmalige favTeam/selTeam-Migration (siehe
            ...
            // (Vereins-Spielbetrieb-Einstellung mit rückwirkender
...
if ($action === 'archiv' && isLoggedIn()) {
    try {
        ...
        // Sortierung der archivierten Ligen innerhalb jedes Ordners (per
        // klickbarer Steuerleiste statt einer festen Vorgabe -
