<!--
  Template: matchday | Filename: tippspiel.tpl.php | Fileversion: 1.2.0
...
<div class="tipp-section-heading"><img src="assets/img/tippspiel-logo.png" alt="" class="tipp-section-heading-logo"><h1><!--Titel--></h1></div>
