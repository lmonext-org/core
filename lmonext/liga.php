 ...
 * (statt eines nicht unterscheidbaren "(*)" bei mehreren
...
switch ($currentView) {
    ...
    case 'ergebnisse':
        ...
        // _gt_tore_beide_verlieren ("beide Mannschaften
        ...
        if ($spieltag === null) {
            ...
            foreach ($groups as $i => $groupPartien) {
                // Fußnoten-Nummerierung (statt eines einzelnen
        ...
        // Bugfix ("vorheriger/nächster Spieltag"-Linkleiste, wie
        ...
        // Bugfix (die untere Vorheriger/Nächster-Spieltag-Leiste
