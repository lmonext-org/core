...
// ausgegliedert (siehe CHANGELOG.md).
// Diese vier Wrapper-Funktionen bleiben im Core
...
// Ticker (als eigenständiges Addon "ticker" ausgegliedert, analog
...
// ohne aktives Addon bleibt der Ticker komplett unsichtbar (kein
...
function renderErgebnisseSpieltagNav(int $ligaId, int $nr, int $maxNr) : string
{
    return \LMOnext\Liga\LigaService::renderErgebnisseSpieltagNav($ligaId, $nr, $maxNr);
}
