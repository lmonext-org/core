...
<head>
<!--
  Template: colored | Filename: layout.tpl.php | Fileversion: 1.8.3
...
table.standings-table thead th{background:var(--grad2);color:#fff;padding:9px 10px;font-weight:600;font-size:.8rem;white-space:nowrap;vertical-align:bottom}
...
<footer class="site"><!--TippspielLink--> <!--Sprachauswahl--><br><!--PoweredBy--><br><!--TemplateZeile--><br><!--Berechnungszeit--></footer>
