...
class AddonManager
{
     ...
     * (analog zu phpBB's "purge extension data").
...
");
     ...
     * Alternative zum manuellen ZIP-Upload für die Erstinstallation
     * eines noch nicht vorhandenen Addons. Anders als installUpdate()
     * (das einen bereits BEKANNTEN Addon-Namen voraussetzt und dessen
     * im Manifest gespeicherte "homepage" nutzt) wird hier nur die
     * Repo-URL selbst benötigt - der Addon-Name ergibt sich erst aus
